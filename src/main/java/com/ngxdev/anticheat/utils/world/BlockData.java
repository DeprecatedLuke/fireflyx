...
import com.ngxdev.anticheat.utils.world.blocks.*;
import com.ngxdev.anticheat.utils.world.types.*;
...
import static com.ngxdev.anticheat.utils.Utils.*;
...
public enum BlockData {
    ...
    _SNOW((protocol, b) -> {
        ...
        return new SimpleCollisionBox(0, 0, 0, 1, height * EIGHTH, 1);
    }, Material.SNOW),
    ...
    _CHEST(new SimpleCollisionBox(0, 0, 0, 1, 1 - EIGHTH, 1).expand(-EIGHTH, 0, -EIGHTH),
            CHEST, TRAPPED_CHEST, ENDER_CHEST),
    _ETABLE(new SimpleCollisionBox(0, 0, 0, 1, 1 - FOURTH, 1),
            ENCHANTMENT_TABLE),
    _FRAME(new SimpleCollisionBox(0, 0, 0, 1, 1 - (SIXTEENTH * 3), 1),
            ENDER_PORTAL_FRAME),
